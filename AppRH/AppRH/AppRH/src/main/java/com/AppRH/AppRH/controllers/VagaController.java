...
public class VagaController {
	...
	public String form(@Valid Vaga vaga, BindingResult result, RedirectAttributes attributes) {
		...
		if(vaga.validaSalario(vaga.getSalario()).equals(BigDecimal.ZERO)) {
			attributes.addFlashAttribute("mensagem_erro", "Não pode salário maior que 30000...");
			return "redirect:/cadastrarVaga";
		}
	...
	@RequestMapping("/editar-vaga/{codigo}")
